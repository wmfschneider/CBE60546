...
\label{sec:org13c2d3b}
\subsection{One way under consideration for removing harmful ``\ce{NO_x}'' (\ce{NO} + \ce{NO2}) from flue gas is the thermal deNOx process, in which \ce{NH3} is used to reduce the \ce{NO} to \ce{N2}:}
\label{sec:org52e2cd9}
...
\item Under the stoichiometric conditions described above, the reactor generates \SI{0.036}{g/s} \ce{NO} and \SI{0.017}{g/s} \ce{N2}. How effectively is the \ce{NH3} being used for thermal deNOx? (\emph{Hint:} What are the advancements of the two reactions?)
\end{enumerate}
