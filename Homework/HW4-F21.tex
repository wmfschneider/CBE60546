...
\subsection{The opposite of ethylene hydrogenation is ethane dehydrogenation, \ce{C2H6 -> 2 CH3}. If the reaction is run in a diluent, say \ce{N2}, the rate is observed to be a function of total pressure and to reach a limiting value at high pressure. Why? Can you propose a simple model for this behavior?}
